...
const appRoutes: Routes = [
  ...
  { path: 'caregiver-profile', component: CaregiverProfileComponent},
  { path: 'eldersEdit/:eldersId', component: EldersSignupComponent },
  ...
  { path: 'requests-status', component: RequestStatusComponent},
